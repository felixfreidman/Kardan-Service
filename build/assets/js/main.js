...
if (document.querySelector('.feedback-item')) {
  ...
  reviews.forEach(function (review) {
    ...
    var reviewStars = review.querySelector('.feedback-item__rating').querySelector("svg");

    switch (star_rating) {
      case '1':
        for (var i = 0; i < 5 - parseInt(star_rating); i++) {
          reviewStars.removeChild(review.querySelector('svg use'));
        }

        for (var _i = 0; _i < 5 - parseInt(star_rating); _i++) {
      ...
      case '2':
        for (var _i2 = 0; _i2 < 5 - parseInt(star_rating); _i2++) {
          reviewStars.removeChild(review.querySelector('svg use'));
        }

        for (var _i3 = 0; _i3 < 5 - parseInt(star_rating); _i3++) {
          var _useElement = document.createElementNS(ns, 'use');

          _useElement.setAttribute('href', '#stars-empty-star');

          reviewStars.appendChild(_useElement);
        }

        break;

      case '3':
        for (var _i4 = 0; _i4 < 5 - parseInt(star_rating); _i4++) {
          reviewStars.removeChild(review.querySelector('svg use'));
        }

        for (var _i5 = 1; _i5 <= 5 - parseInt(star_rating); _i5++) {
          var _useElement2 = document.createElementNS(ns, 'use');

          _useElement2.setAttribute('href', '#stars-empty-star');

          reviewStars.appendChild(_useElement2);
        }

        break;

      case '4':
        for (var _i6 = 0; _i6 < 5 - parseInt(star_rating); _i6++) {
          reviewStars.removeChild(review.querySelector('svg use'));
        }

        for (var _i7 = 1; _i7 <= 5 - parseInt(star_rating); _i7++) {
          var _useElement3 = document.createElementNS(ns, 'use');

          _useElement3.setAttribute('href', '#stars-empty-star');

          reviewStars.appendChild(_useElement3);
        }

        break;

      case '5':
        for (var _i8 = 0; _i8 < 5 - parseInt(star_rating); _i8++) {
          reviewStars.removeChild(review.querySelector('svg use'));
        }

        for (var _i9 = 1; _i9 <= 5 - parseInt(star_rating); _i9++) {
          var _useElement4 = document.createElementNS(ns, 'use');

          _useElement4.setAttribute('href', '#stars-empty-star');

          reviewStars.appendChild(_useElement4);
        }
